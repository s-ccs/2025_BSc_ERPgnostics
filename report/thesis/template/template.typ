...
// Font stacks aligned as closely as practical with the referenced LaTeX template.
#let serif-fonts = ("TeX Gyre Termes", "XCharter", "Charter")
#let sans-fonts = ("TeX Gyre Heros", "Open Sans", "Noto Sans")
#let mono-fonts = ("Inconsolata", "JetBrains Mono", "DejaVu Sans Mono")
...
#let thesis(
  ...
  // Set the body font.
  // Prefer TeX Gyre Termes, with the previous serif stack as fallback.
  set text(font: serif-fonts, size: 11pt)

  // Set raw text font.
  // Prefer Inconsolata, with the previous mono stack as fallback.
  ...
  show heading.where(level: 1): it => {
    ...
    set text(font: sans-fonts, weight: "bold", size: 24pt)
